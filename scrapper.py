...
def main():
    # Configuration
    BASE_URL = "https://collaborate.td.com"  # Update with your actual base URL
    PROJECT_KEYS = ["AMCBDA"]  # Add more project keys as needed
    
    # Initialize scraper
    scraper = JiraProjectScraper(BASE_URL)
    ...
    try:
        ...
        if not df.empty:
            ...
            print("No data was scraped. Please check your configuration and network connectivity.")
